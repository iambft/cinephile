...
/* harmony import */ var _core_interceptors_cors_mocker_interceptor__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./core/interceptors/cors-mocker.interceptor */ "./src/app/core/interceptors/cors-mocker.interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [
            { provide: _app_config__WEBPACK_IMPORTED_MODULE_18__["APP_CONFIG"], useValue: _app_config__WEBPACK_IMPORTED_MODULE_18__["AppConfig"] },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__["HTTP_INTERCEPTORS"], useClass: _core_interceptors_cors_mocker_interceptor__WEBPACK_IMPORTED_MODULE_19__["CorsMocker"], multi: true }
        ],
...
let ApiService = class ApiService {
    ...
    getTrailer(filmTitle) {
        ...
        return this.http.get(`${this.config.apiEndpoint}/trailerAddict/taapi`, Object.assign({}, httpOptions, httpParams)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(this.extractData));
    }
};
...
/***/ "./src/app/core/interceptors/cors-mocker.interceptor.ts":
/*!**************************************************************!*\
  !*** ./src/app/core/interceptors/cors-mocker.interceptor.ts ***!
  \**************************************************************/
/*! exports provided: CorsMocker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CorsMocker", function() { return CorsMocker; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let CorsMocker = class CorsMocker {
    constructor(conf) {
        this.conf = conf;
    }
    intercept(request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(evt => {
...
CorsMocker = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_app_config__WEBPACK_IMPORTED_MODULE_3__["APP_CONFIG"]))
], CorsMocker);
...
let LikedMovieStoreService = class LikedMovieStoreService {
    constructor() {
    ...
    setLikedMoviesToLocalStorage(movies) {
    ...
    removeMovieFromLiked(removedMovie) {
...
let ChartComponent = class ChartComponent {
    ...
    ngOnInit() {
        ...
        this.api.getTopMovies()
            ...
            this.pieChartLabels = lodash__WEBPACK_IMPORTED_MODULE_4__["map"](lodash__WEBPACK_IMPORTED_MODULE_4__["keys"](gropedYears), year => year + '0x');
...
let LikedComponent = class LikedComponent {
    ...
    removeFromLiked([status, movie]) {
        if (!status) {
            this.movieStore.removeMovieFromLiked(movie);
        }
    }
};
LikedComponent.ctorParameters = () => [
...
let TopListComponent = class TopListComponent {
...
TopListComponent.ctorParameters = () => [
...
let MovieCardComponent = class MovieCardComponent {
    constructor(api, movieStore, toastr, config) {
        this.api = api;
        this.movieStore = movieStore;
        this.toastr = toastr;
        this.config = config;
    ...
    ngOnInit() {
        ...
        const status = !!lodash__WEBPACK_IMPORTED_MODULE_4__["find"](likedMovies, { idIMDB });
...
MovieCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_app_config__WEBPACK_IMPORTED_MODULE_6__["APP_CONFIG"]))
], MovieCardComponent);
